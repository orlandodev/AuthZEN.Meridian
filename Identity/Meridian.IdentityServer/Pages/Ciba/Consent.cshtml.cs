...
namespace Meridian.IdentityServer.Pages.Ciba;
...
public class Consent : PageModel
{
    ...
    public async Task<IActionResult> OnGet(string? id)
    {
        ...
        {
            return RedirectToPage("/Home/Error/Index", HttpContext.RequestAborted);
        }
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        if (result != null)
        {
            ...
            return RedirectToPage("/Ciba/All", HttpContext.RequestAborted);
        }
