...
// (DepartmentSpendRules.CanExport), the window evaluated in the organization's
// configured business timezone. The time itself is the PDP's own — it is never
// carried in the request — so a PEP cannot widen the window by lying about the
// clock. A denial collapses to one 403 regardless of which half failed; the
// Portal shows its business-hours message for any 403 here.
